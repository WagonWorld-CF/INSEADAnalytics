...
<br>
<br>
1. _After entering source("dataSet1.R"), the code returns a line: [1] "\nDownloading ticker  AAPL  ..." This is where Apple returns are being downloaded from the dataSet1.R file. 
<br>
<br>
<br>
